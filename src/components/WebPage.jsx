...
const WebPage = () => {
  ...
  const fetchBooks = async () => {
    try {
      ...
      const res = await axios.get("https://library-management-jf5a.onrender.com/api/books");
  ...
  try {
    ...
    await axios.delete(`https://library-management-jf5a.onrender.com/api/books/${id}`);
